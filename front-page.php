      ...
      <section id="contents">
        <section id="malls-pickup">
           <div class="malls-group">
            <?php
            $mall_posts =new WP_Query('posts_per_page=-1&post_type=page
            &orderby=menu_order&order=asc&post_parent=59');
            ...
            <article>
              ...
              <a href="<?php the_permalink(); ?>">
                  <?php the_post_thumbnail('pickup_thumbnail',array(
        ...
        <section id="latest-columns">
          ...
          <div class="column-group head">
            ...
            <article class="column-article" >
              <h1 class="update-title"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
              <?php the_title(); ?></a>
              </h1>
