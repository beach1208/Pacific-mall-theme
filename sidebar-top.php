 <section id="sidebar">
        ...
        $sidebar_posts = new WP_Query('posts_per_page='. $sidebar_cat_num . 'category_name=' .
        $sidebar_cat_name
        );
        ?>
          <aside id="<?php echo $sidebar_cat_name; ?>-info" class="news-list">
            <h1><?php echo esc_html(get_category_by_slug($slidebar_cat_name)->name); ?></h1>
            <div class="info-wrap">
              <ul>
              <?php
              ...
              <?php the_time(get_option('date_format')); ?></time>
                  ...
                  <a href="<?php the_permalink(); ?>">
                   <?php the_post_thumbnail('small_thumbnail',array(
              ...
              <?php echo esc_html(get_category_by_slug($sidebar_cat_name)->name); ?>一覧</a></span>
            </div><!-- .info-wrap end -->
